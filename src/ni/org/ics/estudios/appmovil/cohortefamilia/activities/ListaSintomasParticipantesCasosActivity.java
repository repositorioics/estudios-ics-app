...
import ni.org.ics.estudios.appmovil.cohortefamilia.activities.enterdata.NuevaVisitaSeguimientoSintomasActivity;
import ni.org.ics.estudios.appmovil.cohortefamilia.adapters.VisitaSeguimientoCasoSintomasAdapter;
...
public class ListaSintomasParticipantesCasosActivity extends AbstractAsyncListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		img=getResources().getDrawable(R.drawable.ic_sintomas);
		...
		mAddButton.setOnClickListener(new View.OnClickListener()  {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(getApplicationContext(),
						NuevaVisitaSeguimientoSintomasActivity.class);
	...
	private class FetchDataSintomasCasosTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... values) {
			try {
				...
				mVisitasSeguimientoCasoSintomas = estudiosAdapter.getVisitaSeguimientoCasosSintomas(CasosDBConstants.codigoCasoVisita + "='" + visitaCaso.getCodigoCasoVisita()+"'", CasosDBConstants.fechaSintomas);
		...
		protected void onPostExecute(String resultado) {
			...
			mVisitaSeguimientoCasoSintomasAdapter = new VisitaSeguimientoCasoSintomasAdapter(getApplication().getApplicationContext(), R.layout.complex_list_item,mVisitasSeguimientoCasoSintomas);
			setListAdapter(mVisitaSeguimientoCasoSintomasAdapter);
