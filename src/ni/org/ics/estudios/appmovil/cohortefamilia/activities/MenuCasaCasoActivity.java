...
import ni.org.ics.estudios.appmovil.cohortefamilia.adapters.MenuCasaCasoAdapter;
...
public class MenuCasaCasoActivity extends AbstractAsyncActivity {
    ...
    private boolean fromCasos = true;

    
    private final int OPCION_ENCUESTA_CASA = 0;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		menu_casa = getResources().getStringArray(R.array.menu_casa_caso);
    ...
    private class FetchDataCasaTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String resultado) {
			...
			gridView.setAdapter(new MenuCasaCasoAdapter(getApplicationContext(), R.layout.menu_item_2, menu_casa, mCuartos.size(), existeencuestaCasa, mAreas.size(), mTelefonosContacto.size()));
			dismissProgressDialog();
		}
