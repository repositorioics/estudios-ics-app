...
public class EditarPersonaCamaActivity extends FragmentActivity implements
    ...
    private static PersonaCama pc = new PersonaCama();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		username =
				settings.getString(PreferencesActivity.KEY_USERNAME,
						null);
		infoMovil = new DeviceInfo(EditarPersonaCamaActivity.this);
		cama = (Cama) getIntent().getExtras().getSerializable(Constants.CAMA);
		pc = (PersonaCama) getIntent().getExtras().getSerializable(Constants.PERSONACAMA);
