...
import ni.org.ics.estudios.appmovil.cohortefamilia.activities.ListaVentanasBanioNivel1Activity;
...
public class NuevaVentanaBanioNivel1Activity extends FragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		username =
				settings.getString(PreferencesActivity.KEY_USERNAME,
						null);
		infoMovil = new DeviceInfo(NuevaVentanaBanioNivel1Activity.this);
