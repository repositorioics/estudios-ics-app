    ...
    public void saveData(){
        ...
        if (procesarVisita) {
            ...
            try {
                ...
                List<Muestra> muestrasMA = estudiosAdapter.getMuestrasMA(ConstantsDB.CODIGO + "=" + participanteChfCaso.getParticipante().getParticipante().getCodigo() +" and ("+ConstantsDB.BHC + "=1 or "+ConstantsDB.ROJO + "=1 or "+ConstantsDB.LEU + "=1)" ,null);
