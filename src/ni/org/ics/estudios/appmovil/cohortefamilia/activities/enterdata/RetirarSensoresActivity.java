...
import ni.org.ics.estudios.appmovil.cohortefamilia.activities.fragments.RetirarSensoresFragment;
import ni.org.ics.estudios.appmovil.domain.cohortefamilia.casos.CasaCohorteFamiliaCaso;
import ni.org.ics.estudios.appmovil.utils.Constants;


public class RetirarSensoresActivity extends FragmentActivity {

    public static final String TAG = "RetirarSensoresActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCasaCaso = (CasaCohorteFamiliaCaso) getIntent().getExtras().getSerializable(Constants.CASA);
