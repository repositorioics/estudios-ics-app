 ...
 * V1.0
 */
public class MuestraBHCPaxgeneForm extends AbstractWizardModel {
    ...
    public MuestraBHCPaxgeneForm(Context context, String pass) {
        super(context,pass);
    }
    ...
    protected PageList onNewRootPageList() {
        ...
        Page scRealizaPax = new SingleFixedChoicePage(this, labels.getRealizaPaxgene(), labels.getRealizaPaxgeneHint(), Constants.WIZARD, false).setChoices(catSiNo).setRequired(true);
        Page lpHoraInicioPax = new LabelPage(this, labels.getHoraInicioPax(), "", Constants.WIZARD, false).setRequired(true);

        return new PageList(lpInicio, scTomaMxSn,scRazonNoToma,tpDescOtraRazonNoToma, bcCodigoMx, npVolumen, scObservacion, tpDescOtraObservacion, scNumPinchazos, scRealizaPax, lpHoraInicioPax);
    }
}
