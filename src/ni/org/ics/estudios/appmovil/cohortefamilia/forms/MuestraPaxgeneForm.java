...
public class MuestraPaxgeneForm extends AbstractWizardModel {
    ...
    protected PageList onNewRootPageList() {
        ...
        return new PageList(scTomaMxSn,scRazonNoToma,tpDescOtraRazonNoToma, bcCodigoMx, tpHora, npVolumen, scObservacion, tpDescOtraObservacion, scNumPinchazos, lpHoraInicioPax, lpHoraFinPax);
    }
}
