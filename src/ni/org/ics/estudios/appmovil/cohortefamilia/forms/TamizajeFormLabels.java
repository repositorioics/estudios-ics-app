...
public class TamizajeFormLabels {
	...
	protected String asisteCSSF;
	protected String asisteCSSFHint;
	...
	protected String siEnfermaSoloAsistirCSSF;
	protected String siEnfermaSoloAsistirCSSFHint;
	protected String elegible;
	protected String elegibleHint;
	
	protected String participadoCohortePediatrica;
	protected String participadoCohortePediatricaHint;
	protected String cohortePediatrica;
	protected String cohortePediatricaHint;
	protected String codigoReactivado;
	protected String codigoReactivadoHint;
	protected String codigoEscaneado;
	...
	public TamizajeFormLabels(){
		...
		asisteCSSF = res.getString(R.string.asisteCSSF);
		asisteCSSFHint = res.getString(R.string.asisteCSSFHint);
		...
		siEnfermaSoloAsistirCSSF = res.getString(R.string.siEnfermaSoloAsistirCSSF);
		siEnfermaSoloAsistirCSSFHint = res.getString(R.string.siEnfermaSoloAsistirCSSFHint);
		elegible = res.getString(R.string.elegible);
		elegibleHint = res.getString(R.string.elegibleHint);
		...
		cohortePediatrica = res.getString(R.string.cohortePediatrica);
		cohortePediatricaHint = res.getString(R.string.cohortePediatricaHint);
		codigoReactivado = res.getString(R.string.codigoReactivado);
		codigoReactivadoHint = res.getString(R.string.codigoReactivadoHint);
		codigoEscaneado = res.getString(R.string.codigoEscaneado);
	...
	public String getAsisteCSSF() {
		return asisteCSSF;
	}

	public void setAsisteCSSF(String asisteCSSF) {
		this.asisteCSSF = asisteCSSF;
	}

	public String getAsisteCSSFHint() {
		return asisteCSSFHint;
	}

	public void setAsisteCSSFHint(String asisteCSSFHint) {
		this.asisteCSSFHint = asisteCSSFHint;
	}
	...
	public String getSiEnfermaSoloAsistirCSSF() {
		return siEnfermaSoloAsistirCSSF;
	}

	public void setSiEnfermaSoloAsistirCSSF(String siEnfermaSoloAsistirCSSF) {
		this.siEnfermaSoloAsistirCSSF = siEnfermaSoloAsistirCSSF;
	}

	public String getSiEnfermaSoloAsistirCSSFHint() {
		return siEnfermaSoloAsistirCSSFHint;
	}

	public void setSiEnfermaSoloAsistirCSSFHint(String siEnfermaSoloAsistirCSSFHint) {
		this.siEnfermaSoloAsistirCSSFHint = siEnfermaSoloAsistirCSSFHint;
	}
	...
	public String getElegibleHint() {
		return elegibleHint;
	}

	public void setElegibleHint(String elegibleHint) {
		this.elegibleHint = elegibleHint;
	}
	...
	public String getCohortePediatricaHint() {
		return cohortePediatricaHint;
	}

	public void setCohortePediatricaHint(String cohortePediatricaHint) {
		this.cohortePediatricaHint = cohortePediatricaHint;
	}

	public String getCodigoReactivado() {
		return codigoReactivado;
	}

	public void setCodigoReactivado(String codigoReactivado) {
		this.codigoReactivado = codigoReactivado;
	}

	public String getCodigoReactivadoHint() {
		return codigoReactivadoHint;
	}

	public void setCodigoReactivadoHint(String codigoReactivadoHint) {
		this.codigoReactivadoHint = codigoReactivadoHint;
	}
	...
	public void setCodigoEscaneado(String codigoEscaneado) {
		this.codigoEscaneado = codigoEscaneado;
	}
