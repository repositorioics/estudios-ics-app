...
public class VentanaForm extends AbstractWizardModel {
	

	private AreaAmbienteCasaFormLabels labels;
	private EstudiosAdapter estudiosAdapter;
	int index = 0;
	private String[] catAbierta;
    ...
    public VentanaForm(Context context, String pass) {    	
        super(context,pass);
    }
    ...
    protected PageList onNewRootPageList() {
    	...
    	catAbierta = fillCatalog("CHF_CAT_SINO");
		...
		Page abierta = new SingleFixedChoicePage(this,labels.getAbierta(),"", Constants.WIZARD, true).setChoices(catAbierta).setRequired(true);	
        return new PageList(largo,ancho,totalM2,abierta);
    }
