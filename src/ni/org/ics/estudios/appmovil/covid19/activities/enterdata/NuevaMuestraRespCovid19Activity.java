 ...
 * V1.0
 */
public class NuevaMuestraRespCovid19Activity extends FragmentActivity implements
    ...
    private static ParticipanteCasoCovid19 participanteCasoCovid19 = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        username =
                settings.getString(PreferencesActivity.KEY_USERNAME,
                        null);
        infoMovil = new DeviceInfo(NuevaMuestraRespCovid19Activity.this);
        ...
        if (visitaCaso!=null) participanteCasoCovid19 = visitaCaso.getCodigoParticipanteCaso();
...
/*
    ...
    public void saveData() {
        try {
            ...
            muestra.setProposito(Constants.CODIGO_PROPOSITO_T_COVID);
            //listas
            ...
            if (tomaMxSn.equalsIgnoreCase(Constants.YES)) {
                muestra.setTipoMuestra(Constants.CODIGO_TIPO_HN);//Hisapdo Nasal
                muestra.setTubo(Constants.CODIGO_MEDIO);//Medio
            }else{
                muestra.setTipoMuestra("9"); //Sin muestra
                muestra.setTubo("9");//SM
            }
