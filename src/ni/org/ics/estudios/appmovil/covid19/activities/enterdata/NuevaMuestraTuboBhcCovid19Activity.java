 ...
 * V1.0
 */
public class NuevaMuestraTuboBhcCovid19Activity extends FragmentActivity implements
    ...
    private Double volumenMaximoPermitido = 1D;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        username =
                settings.getString(PreferencesActivity.KEY_USERNAME,
                        null);
        infoMovil = new DeviceInfo(NuevaMuestraTuboBhcCovid19Activity.this);
        ...
        volumenMaximoPermitido = getIntent().getDoubleExtra(Constants.VOLUMEN, 1);
    ...
    public void saveData() {
        try {
            ...
            if (participanteCasoCovid19 !=null)
                participante = participanteCasoCovid19.getParticipante();
            //else
            ...
            muestra.setTubo(Constants.CODIGO_TUBO_BHC); //Rojo
