...
import ni.org.ics.estudios.appmovil.covid19.activities.fragments.NuevoSintomaVisitaFinalCovid19Fragment;
import ni.org.ics.estudios.appmovil.domain.covid19.VisitaFinalCasoCovid19;
import ni.org.ics.estudios.appmovil.utils.Constants;


public class NuevoSintomasVisitaFinalCovid19Activity extends FragmentActivity {

    public static final String TAG = "NuevoSintomasVisitaFinalCovid19Activity";
    
    private Button mCancelView;
    private static final int EXIT = 1;
    private AlertDialog alertDialog;
    private VisitaFinalCasoCovid19 mVisita;
    
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_data_enter);
        mVisita = (VisitaFinalCasoCovid19) getIntent().getExtras().getSerializable(Constants.VISITA_FINAL);
		...
		case EXIT:
			...
			builder.setPositiveButton(this.getString(R.string.yes), new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent i;
					arguments.putSerializable(Constants.VISITA_FINAL , mVisita);
