...
/*
            ...
            mCuestionario.setE1SabeFIS(sabeFIS);
            if (fis!=null && !fis.isEmpty()) mCuestionario.setE1Fis(formatter.parse(fis));
            mCuestionario.setE1MesInicioSintoma(mesInicioSintoma);
            mCuestionario.setE1AnioInicioSintoma(anioInicioSintoma);
            //mCuestionario.setPadecidoCovid19(padecidoCovid19);
            mCuestionario.setE1ConoceLugarExposicion(conoceLugarExposicion);
            mCuestionario.setE1LugarExposicion(lugarExposicion);
            mCuestionario.setE1BuscoAyuda(buscoAyuda);
            mCuestionario.setE1DondeBuscoAyuda(dondeBuscoAyuda);
            mCuestionario.setE1NombreCentroSalud(nombreCentroSalud);
            mCuestionario.setE1NombreHospital(nombreHospital);
            mCuestionario.setE1RecibioSeguimiento(recibioSeguimiento);
            mCuestionario.setE1TipoSeguimiento(tipoSeguimiento);
            mCuestionario.setE1TmpDespuesBuscoAyuda(tmpDespuesBuscoAyuda);
            mCuestionario.setE1UnaNocheHospital(unaNocheHospital);
            mCuestionario.setE1QueHospital(queHospital);
            mCuestionario.setE1SabeCuantasNoches(sabeCuantasNoches);
            mCuestionario.setE1CuantasNochesHosp(cuantasNochesHosp);
            mCuestionario.setE1SabeFechaAdmision(sabeFechaAdmision);
            if (fechaAdmisionHosp!=null && !fechaAdmisionHosp.isEmpty()) mCuestionario.setE1FechaAdmisionHosp(formatter.parse(fechaAdmisionHosp));
            mCuestionario.setE1SabeFechaAlta(sabeFechaAlta);
            if (fechaAltaHosp!=null && !fechaAltaHosp.isEmpty()) mCuestionario.setE1FechaAltaHosp(formatter.parse(fechaAltaHosp));
            mCuestionario.setE1UtilizoOxigeno(utilizoOxigeno);
            mCuestionario.setE1EstuvoUCI(estuvoUCI);
            mCuestionario.setE1FueIntubado(fueIntubado);
            mCuestionario.setE1RecuperadoCovid19(recuperadoCovid19);
            mCuestionario.setE1TieneFebricula(febricula);
            mCuestionario.setE1TieneCansancio(cansancio);
            mCuestionario.setE1TieneDolorCabeza(dolorCabeza);
            mCuestionario.setE1TienePerdidaOlfato(perdidaOlfato);
            mCuestionario.setE1TienePerdidaGusto(perdidaGusto);
            mCuestionario.setE1TieneTos(tos);
            mCuestionario.setE1TieneDificultadRespirar(dificultadRespirar);
            mCuestionario.setE1TieneDolorPecho(dolorPecho);
            mCuestionario.setE1TienePalpitaciones(palpitaciones);
            mCuestionario.setE1TieneDolorArticulaciones(dolorArticulaciones);
            mCuestionario.setE1TieneParalisis(paralisis);
            mCuestionario.setE1TieneMareos(mareos);
            mCuestionario.setE1TienePensamientoNublado(pensamientoNublado);
            mCuestionario.setE1TieneProblemasDormir(problemasDormir);
            mCuestionario.setE1TieneDepresion(depresion);
            mCuestionario.setE1TieneOtrosSintomas(otrosSintomas);
            mCuestionario.setE1cualesSintomas(cualesSintomas);
            mCuestionario.setE1SabeTiempoRecuperacion(sabeTiempoRecuperacion);
            mCuestionario.setE1TiempoRecuperacion(tiempoRecuperacion);
            mCuestionario.setE1TiempoRecuperacionEn(tiempoRecuperacionEn);
            mCuestionario.setE1SeveridadEnfermedad(severidadEnfermedad);
            mCuestionario.setE1TomoMedicamento(tomoMedicamento);
            ...
            mCuestionario.setE1OtroMedicamento(otroMedicamento);
            ...
            mCuestionario.setE1FumadoPrevioEnfermedad(fumadoPrevioEnfermedad);
            mCuestionario.setE1FumaActualmente(fumaActualmente);
            mCuestionario.setE1Embarazada(embarazada);
            mCuestionario.setE1RecuerdaSemanasEmb(recuerdaSemanasEmb);
            mCuestionario.setE1SemanasEmbarazo(semanasEmbarazo);
            mCuestionario.setE1FinalEmbarazo(finalEmbarazo);
            mCuestionario.setE1OtroFinalEmbarazo(otroFinalEmbarazo);
            mCuestionario.setE1DabaPecho(dabaPecho);
