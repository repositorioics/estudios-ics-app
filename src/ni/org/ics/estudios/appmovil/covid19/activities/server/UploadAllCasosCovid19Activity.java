...
public class UploadAllCasosCovid19Activity extends Activity implements UploadListener {

	protected static final String TAG = UploadAllCasosCovid19Activity.class.getSimpleName();

	private String username;
	private String password;
	private String url;
	private SharedPreferences settings;
	private UploadAllCasosCovid19Task uploadAllTask;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		uploadAllTask = (UploadAllCasosCovid19Task) getLastNonConfigurationInstance();
	...
	private void uploadAll() {
		uploadAllTask =  new UploadAllCasosCovid19Task(this.getApplicationContext());
		uploadAllTask.setUploadListener(UploadAllCasosCovid19Activity.this);
