...
public class ParticipantePosCasoCovid19Adapter extends ArrayAdapter<ParticipanteCasoCovid19> {

	private SimpleDateFormat mDateFormat = new SimpleDateFormat("MMM dd, yyyy");
    private SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
	private List<MessageResource> catalogos;
	public ParticipantePosCasoCovid19Adapter(Context context, int textViewResourceId,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (p != null && p.getParticipante()!=null) {
			...
			if (textView != null) {
				if (p.getCodigoCaso().getCasa()!=null)
					textView.setText(this.getContext().getString(R.string.code) + ": " + p.getParticipante().getCodigo() +" - Casa CHF: " + p.getCodigoCaso().getCasa().getCodigoCHF());
				else textView.setText(this.getContext().getString(R.string.code) + ": " + p.getParticipante().getCodigo());
			}
