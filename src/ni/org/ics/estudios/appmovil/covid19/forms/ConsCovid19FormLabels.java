 ...
 * V1.0
 */
public class ConsCovid19FormLabels {
    ...
    private String aceptaCohorteFLuParteDCovid;
    private String aceptaCohorteFLuParteDCovidHint;
    private String aceptaCohorteFLuParteECovid;
    private String aceptaCohorteFLuParteECovidHint;
    ...
    public ConsCovid19FormLabels() {
        ...
        aceptaCohorteFLuParteDCovid = res.getString(R.string.aceptaCohorteFLuParteDCovid);
        aceptaCohorteFLuParteDCovidHint = res.getString(R.string.aceptaCohorteFLuParteDCovidHint);
        aceptaCohorteFLuParteECovid = res.getString(R.string.aceptaCohorteFLuParteECovid);
        aceptaCohorteFLuParteECovidHint = res.getString(R.string.aceptaCohorteFLuParteECovidHint);
    ...
    public String getAceptaCohorteFLuParteDCovid() {
        return aceptaCohorteFLuParteDCovid;
    }

    public void setAceptaCohorteFLuParteDCovid(String aceptaCohorteFLuParteDCovid) {
        this.aceptaCohorteFLuParteDCovid = aceptaCohorteFLuParteDCovid;
    }

    public String getAceptaCohorteFLuParteDCovidHint() {
        return aceptaCohorteFLuParteDCovidHint;
    }

    public void setAceptaCohorteFLuParteDCovidHint(String aceptaCohorteFLuParteDCovidHint) {
        this.aceptaCohorteFLuParteDCovidHint = aceptaCohorteFLuParteDCovidHint;
    }

    public String getAceptaCohorteFLuParteECovid() {
        return aceptaCohorteFLuParteECovid;
    }

    public void setAceptaCohorteFLuParteECovid(String aceptaCohorteFLuParteECovid) {
        this.aceptaCohorteFLuParteECovid = aceptaCohorteFLuParteECovid;
    }

    public String getAceptaCohorteFLuParteECovidHint() {
        return aceptaCohorteFLuParteECovidHint;
    }

    public void setAceptaCohorteFLuParteECovidHint(String aceptaCohorteFLuParteECovidHint) {
        this.aceptaCohorteFLuParteECovidHint = aceptaCohorteFLuParteECovidHint;
    }
    ...
    public void setAceptaCohorteUO1ParteDCovid(String aceptaCohorteUO1ParteDCovid) {
        this.aceptaCohorteUO1ParteDCovid = aceptaCohorteUO1ParteDCovid;
    }
    ...
    public void setAceptaCohorteUO1ParteDCovidHint(String aceptaCohorteUO1ParteDCovidHint) {
        this.aceptaCohorteUO1ParteDCovidHint = aceptaCohorteUO1ParteDCovidHint;
    }
    ...
    public void setRazonNoAceptaParteD(String razonNoAceptaParteD) {
        this.razonNoAceptaParteD = razonNoAceptaParteD;
    }
    ...
    public void setOtraRazonNoAceptaParteD(String otraRazonNoAceptaParteD) {
        this.otraRazonNoAceptaParteD = otraRazonNoAceptaParteD;
    }
    ...
    public void setRazonNoAceptaParteDHint(String razonNoAceptaParteDHint) {
        this.razonNoAceptaParteDHint = razonNoAceptaParteDHint;
    }
    ...
    public void setOtraRazonNoAceptaParteDHint(String otraRazonNoAceptaParteDHint) {
        this.otraRazonNoAceptaParteDHint = otraRazonNoAceptaParteDHint;
    }
