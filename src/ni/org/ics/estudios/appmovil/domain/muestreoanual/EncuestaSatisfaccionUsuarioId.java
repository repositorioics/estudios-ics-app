...
public class EncuestaSatisfaccionUsuarioId implements Serializable {
    private static final long serialVersionUID = 1L;
    private Integer codigo;
    private Date fecha;

    public EncuestaSatisfaccionUsuarioId() {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PesoyTallaId))
            return false;
        EncuestaSatisfaccionUsuarioId castOther = (EncuestaSatisfaccionUsuarioId) other;
