...
public class TamizajeHelper {
    ...
    public static Tamizaje crearTamizaje(Cursor cursor){
        ...
        mTamizaje.setAceptaTamizajePersona(cursor.getString(cursor.getColumnIndex(MainDBConstants.aceptaTamizajePersona)).charAt(0));
        ...
        mTamizaje.setAceptaAtenderCentro(cursor.getString(cursor.getColumnIndex(MainDBConstants.aceptaAtenderCentro)).charAt(0));
        mTamizaje.setEsElegible(cursor.getString(cursor.getColumnIndex(MainDBConstants.esElegible)).charAt(0));
        mTamizaje.setAceptaParticipar(cursor.getString(cursor.getColumnIndex(MainDBConstants.aceptaParticipar)).charAt(0));
        mTamizaje.setRazonNoAceptaParticipar(cursor.getString(cursor.getColumnIndex(MainDBConstants.razonNoAceptaParticipar)).charAt(0));
        mTamizaje.setAsentimientoVerbal(cursor.getString(cursor.getColumnIndex(MainDBConstants.asentimientoVerbal)).charAt(0));
