...
import ni.org.ics.estudios.appmovil.muestreoanual.tasks.DownloadParticipanteTask;
...
public class DownloadParticipanteActivity extends Activity implements DownloadListener{
	...
	private void downloadAllData(){   
		...
		downloadParTask = new DownloadParticipanteTask(this.getApplicationContext());
