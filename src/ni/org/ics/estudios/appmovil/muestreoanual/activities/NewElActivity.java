...
import ni.org.ics.estudios.appmovil.domain.muestreoanual.LactanciaMaterna;
import ni.org.ics.estudios.appmovil.domain.muestreoanual.LactanciaMaternaId;
import ni.org.ics.estudios.appmovil.domain.muestreoanual.MovilInfo;
import ni.org.ics.estudios.appmovil.muestreoanual.parsers.EncuestaLactanciaXml;
...
public class NewElActivity extends AbstractAsyncActivity {
	...
	public void parseEstacionEL(Integer idInstancia, String instanceFilePath, String ultimoCambio) {
		...
		try {
			...
			estudiosAdapter.crearLactanciaMaterna(mLactanciaMaterna);
			mParticipante.getProcesos().setEncLacMat("No");
