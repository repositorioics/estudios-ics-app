...
import ni.org.ics.estudios.appmovil.domain.muestreoanual.NewVacunaId;
import ni.org.ics.estudios.appmovil.muestreoanual.parsers.NewVacXml;
...
public class NewNewVaccActivity extends AbstractAsyncActivity {

	protected static final String TAG = NewNewVaccActivity.class.getSimpleName();
	...
	public void parseVacuna(Integer idInstancia, String instanceFilePath, String ultimoCambio) {
		...
		try {
			NewVacXml em = new NewVacXml();
			em = serializer.read(NewVacXml.class, source);
			NewVacunaId vacId = new NewVacunaId();
			vacId.setCodigo(codigo);
			vacId.setFechaRegistroVacuna(new Date());
			mVacuna.setVacunaId(vacId);
			mVacuna.setVacuna_sn(em.getVacuna_sn());
			mVacuna.setOtroMotivoTvacunano(em.getOtroMotivoTvacunano());
			mVacuna.setTvacunano(em.getTvacunano());
