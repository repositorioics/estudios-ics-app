...
import ni.org.ics.estudios.appmovil.domain.muestreoanual.ObsequioId;
import ni.org.ics.estudios.appmovil.muestreoanual.parsers.ObsequioXml;
...
public class NewObActivity extends AbstractAsyncActivity {
	...
	private void addObsequio() {
		try{
			...
			valores[0] = "conmx";
			valores[1] = mParticipante.getProcesos().getConmx();
			valores[2] = "conmxbhc";
			valores[3] = mParticipante.getProcesos().getConmxbhc();
			valores[4] = "confirmar";
