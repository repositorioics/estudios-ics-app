 ...
 * V1.0
 */
public class NuevaMuestraAdicRojoDenActivity extends FragmentActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        username =
                settings.getString(PreferencesActivity.KEY_USERNAME,
                        null);
        infoMovil = new DeviceInfo(NuevaMuestraAdicRojoDenActivity.this);
        ...
        //seter el máximo permitido para el volumen de la muestra. Todos 6Ml
        volumenMaximoPermitido = 8D;  //6 requerido +2 de desviación
    ...
    public void saveData() {
        try {
            ...
            muestra.setProposito(Constants.CODIGO_PROPOSITO_ADIC_DEN);//Dengue Parte E
            //listas
            ...
            if (tieneValor(tomaMxSn)) procesos.setMxDenParteE(tomaMxSn.equalsIgnoreCase(Constants.YES)?Constants.NO:Constants.YES);
