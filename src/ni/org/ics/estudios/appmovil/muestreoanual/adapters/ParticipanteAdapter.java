		...
		if (procesos != null) {
            ...
            if (procesos.getEstPart().equals(0) && (procesos.getReConsDeng()==null || procesos.getReConsDeng().matches("No"))){
				...
				if (procesos.getConsFlu().matches("Si")|| procesos.getPesoTalla().matches("Si")
                    ...
                    if (procesos.getConsCovid19().matches("Si")) labelHeader = labelHeader + (!procesos.getEstudio().trim().contains("Influenza")?"Consentimiento COVID19<br />":"Reconsentimiento Influeza<br />");
