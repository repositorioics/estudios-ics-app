 ...
 * V1.0
 */
public class ConFluUO1Form extends AbstractWizardModel {

    int index = 0;
    private ConFluUO1FormLabels labels;
    ...
    public ConFluUO1Form(Context context, String pass) {
        super(context,pass);
    }

    @Override
    protected PageList onNewRootPageList() {
        labels = new ConFluUO1FormLabels();
        ...
        */
        ...
        return new PageList(visExit, visNoExit, dejoCarta, noDejoCarta, personaDejoCarta, relFamPersonaDejoCarta, personaCasa, relacionFamPersonaCasa, otraRelacionPersonaCasa, telefonoPersonaCasa,
                ...
                tomaTx, cualesTx, otroTx, asiste, ocentrosalud, puestosalud, aceptaContactoFuturo, parteBDen, parteCDen, asentimiento,
                ...
                domicilio, cmDomicilio, notaCmDomicilio, telefono1SN, telefonoClasif1, telefonoCel1, telefonoOper1, telefono2SN, telefonoClasif2, telefonoCel2, telefonoOper2, telefono3SN,
                telefonoClasif3, telefonoCel3, telefonoOper3, //jefeFam, cambiarJefe, jefenom, jefenom2, jefeap, jefeap2,
                nomContacto, barrioContacto, otrobarrioContacto, direContacto,
