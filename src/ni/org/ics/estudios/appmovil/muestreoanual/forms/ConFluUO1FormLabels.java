 ...
 * V1.0
 */
public class ConFluUO1FormLabels {
    ...
    public ConFluUO1FormLabels() {
        ...
        aceptaParticipar = res.getString(R.string.aceptaCohorteFLuUO1);
        razonNoAceptaDengue = res.getString(R.string.razonNoAceptaInfluenzaUO1);
        razonNoAceptaDengueHint = res.getString(R.string.razonNoAceptaInfluenzaUO1Hint);
        otraRazonNoAceptaDengue = res.getString(R.string.otraRazonNoAceptaInfluenzaUO1);
        otraRazonNoAceptaDengueHint = res.getString(R.string.otraRazonNoAceptaInfluenzaUO1Hint);
        ...
        incDen = res.getString(R.string.incFluUO1);
        ...
        pretermino = res.getString(R.string.preterminoUO1);
        enfermedadInmuno = res.getString(R.string.enfermedadInmunoUO1);
        enfCronSN = res.getString(R.string.enfCronSNUO1);
        enfCronica = res.getString(R.string.enfCronicaUO1);
        ...
        tomaTx = res.getString(R.string.tomaTxUO1);
        cualesTx = res.getString(R.string.cualesTxUO1);
        otroTx = res.getString(R.string.otroTx);
        asiste = res.getString(R.string.asisteUO1);
        ocentrosalud = res.getString(R.string.ocentrosaludUO1);
        puestosalud = res.getString(R.string.puestosaludUO1);
        asentimiento = res.getString(R.string.asentimientoUO1);
        asentimientoHint = res.getString(R.string.asentimientoHint);
        noAsentimiento = res.getString(R.string.noAsentimiento);
        aceptaContactoFuturo = res.getString(R.string.aceptaContactoFuturoUO1);
        aceptaContactoFuturoHint = res.getString(R.string.aceptaContactoFuturoHint);
        parteBDen = res.getString(R.string.aceptaParteBInfUO1);
        parteBDenHint = res.getString(R.string.aceptaParteBInfHint);
        parteCDen = res.getString(R.string.aceptaParteCInfUO1);
        parteCDenHint = res.getString(R.string.aceptaParteCInfHint);
