 ...
 * V1.0
 */
public class ConsChfForm extends AbstractWizardModel {

    int index = 0;
    private ConsChfFormLabels labels;
    ...
    public ConsChfForm(Context context, String pass) {
        super(context,pass);
    }

    @Override
    protected PageList onNewRootPageList() {
        labels = new ConsChfFormLabels();
        ...
        String[] catCriteriosInclusionI = fillCatalog("CHF_CAT_CI");
        ...
        Page aceptaParteB = new SingleFixedChoicePage(this,labels.getAceptaParteB(), labels.getAceptaParteBIndiceHint(), Constants.WIZARD, false).setChoices(catSiNo).setRequired(true);
        Page aceptaParteC = new SingleFixedChoicePage(this,labels.getAceptaParteC(), labels.getAceptaParteCIndiceHint() , Constants.WIZARD, false).setChoices(catSiNo).setRequired(true);
