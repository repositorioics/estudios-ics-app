 ...
 * V1.0
 */
public class ConsChfFormLabels {
    ...
    private String aceptaParteC;
    private String aceptaParteCIndiceHint;
...
*/
        ...
        aceptaParteAIndiceHint = res.getString(R.string.aceptaParteAHint);
        razonNoAceptaParteA = res.getString(R.string.razonNoAceptaParteA);
        razonNoAceptaParteAHint = res.getString(R.string.razonNoAceptaParteAChfHint);
        ...
        aceptaParteBIndiceHint = res.getString(R.string.aceptaParteBHint);

        aceptaParteC = res.getString(R.string.aceptaParteC);
        aceptaParteCIndiceHint = res.getString(R.string.aceptaParteCHint);
    ...
    public String getAceptaParteCIndiceHint() {
        return aceptaParteCIndiceHint;
    }
