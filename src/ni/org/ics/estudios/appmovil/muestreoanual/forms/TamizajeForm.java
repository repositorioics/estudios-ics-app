...
public class TamizajeForm extends AbstractWizardModel {
    ...
    protected PageList onNewRootPageList() {
        ...
        Page enfermedad = new SingleFixedChoicePage(this,labels.getEnfermedad(), labels.getEnfermedadHint(), Constants.WIZARD, true).setChoices(catSiNo).setRequired(true);
        ...
        Page codigoCasaCohorte = new NumberPage(this,labels.getCodigoCasaCohorte(),"",Constants.WIZARD,true).setRequired(true);
		...
		return new PageList(fechaNacimiento, sexo, aceptaTamizajePersona, razonNoParticipaPersona, otraRazonNoParticipaPersona,
                ...
                casaPerteneceCohorte, codigoCasaCohorte, nombre1JefeFamilia, nombre2JefeFamilia, apellido1JefeFamilia, apellido2JefeFamilia, barrio, manzana, direccion,
