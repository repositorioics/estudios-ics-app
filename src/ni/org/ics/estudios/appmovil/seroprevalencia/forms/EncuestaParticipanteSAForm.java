...
public class EncuestaParticipanteSAForm  extends AbstractWizardModel {
    ...
    protected PageList onNewRootPageList() {
        ...
        Page scFechaZika = new NumberPage(this, labels.getFechaZika(), "", Constants.WIZARD, false).setRequired(true);
        ...
        Page npFechaDengue = new NumberPage(this, labels.getTenidoDengueSn(), "", Constants.WIZARD, false).setRequired(true);
        ...
        Page npFechaChik = new NumberPage(this, labels.getFechaChik(), "", Constants.WIZARD, false).setRequired(true);
        ...
        Page dpFechaTransfusionSangre = new NewDatePage(this, labels.getFechaTransfusionSangre(), "", Constants.WIZARD, false).setRequired(true);
        ...
        return new PageList(scEscuchadoZikaSn,scQueEsSika,tpOtroQueEsSika,scTransmiteZika,tpOtroTransmiteZika,scSintomas,scTenidoZikaSn,scFechaZika,scSintomasZika,scZikaConfirmadoMedico,scTenidoDengueSn,npFechaDengue,scDengueConfirmadoMedico,
