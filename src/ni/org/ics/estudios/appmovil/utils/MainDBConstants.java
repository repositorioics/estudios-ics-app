...
public class MainDBConstants {
    ...
    public static final String aceptaParteF = "aceptaParteF";
    ...
    public static final String ENCUESTA_SATISFACCION_USUARIO_CC_TABLE = "encuestaSatisfaccionUsuariocc";
    ...
    public static final String INSERT_ENCUESTA_SATISFACCION_USUARIO_TABLE = "insert into "
            ...
            + familaAmistades + ", "
            + desicionPropia + ", "
            + obsequiosOfreceEstudio + ", "
            + ayudaRecibeComunidad + ", "
            + examenesLaboratorio + ", "
            + interesCientificoPersonalP1 + ", "
            + informacionAyudaOtros + ", "
            + otraP1 + ", "
            + calidadAtencionMedica + ", "
            + atencionOportuna + ", "
            + buenaCoordinacionhosp + ", "
            + infoEstadoSalud + ", "
            + enseniaPrevEnfermedades + ", "
            + infoConsMejoraConocimientos + ", "
            + interesCientificoPersonalP2 + ", "
            + mejorarTratamientoDengue + ", "
            + unicaManeraRecibirAtencionMed + ", "
            + otraP2 + ", "
            + difBuscarAtencionMed + ", "
            + centroSaludLejos + ", "
            + costoTrasnporteElevado + ", "
            + trabajoTiempo + ", "
            + noQueriapasarConsulta + ", "
            + horarioClases + ", "
            + temorTomenMx + ", "
            + temorInfoPersonal + ", "
            + otraP3 + ", "
            + recomendariaAmigoFamiliar + ", "
            + atencionCalidad + ", "
            + respNecesidadesSaludOportuna + ", "
            + tiempoEsperaCorto + ", "
            + mejorAtencionQueSeguro + ", "
            + examenLabNecesarios + ", "
            + conocimientosImportantes + ", "
            + pocosRequisitos + ", "
            + otraP_4_1 + ", "
            + atencionPersonalMala + ", "
            + noDanRespNecesidades + ", "
            + tiempoEsperaLargo + ", "
            + mejorAtencionOtraUnidadSalud + ", "
            + solicitaDemasiadaMx + ", "
            + muchosRequisitos + ", "
            + noExplicanHacenMx + ", "
            + noConfianza + ", "
            + otraP_4_2 + ", "
            + comprendeProcedimientos + ", "
            + noComodoRealizarPreg + ", "
            + noRespondieronPreg + ", "
            + explicacionRapida + ", "
            + noDejaronHacerPreg + ", "
            + otraP_5_1 + ", "
            + brindaronConsejosPrevencionEnfer + ", "
            + entiendoProcedimientosEstudios + ", "
            + satisfecho + ", "
            + comodoInfoRecolectada + ", "
            + noComodoPreguntas + ", "
            + recomendacionMejorarAtencion + ", "
            + importanciaRecibirInformacion + ", "
            + identificadoEquipo + ", "
            + pasive + ", "
            + estado + ", "
            + fechaRegistro + ", "
    ...
    //Crear tabla encuesta satiscaccion usuario control de calidad
    public static final String CREATE_ENCUESTA_SATISFACCION_USUARIO_CC_TABLE = "create table if not exists "
            + ENCUESTA_SATISFACCION_USUARIO_CC_TABLE + " ("
            + codigoParticipante + " integer not null, "
            + atencionMedica + " text, "
            + familaAmistades + " text, "
            + desicionPropia + " text, "
    ...
    public static final String INSERT_ENCUESTA_SATISFACCION_USUARIO_CC_TABLE = "insert into "
            + ENCUESTA_SATISFACCION_USUARIO_CC_TABLE + " ("
            + codigoParticipante + ", "
            + atencionMedica + ", "
            + familaAmistades + ", "
