package ni.org.ics.estudios.appmovil.utils.zbar.core;
...
public class ViewFinderView extends View implements IViewFinder {
    ...
    int mDefaultLaserColor = Color.parseColor("#CC0000");
    int mDefaultBorderColor = Color.parseColor("#FFFFFF");
    int mDefaultMaskColor = Color.parseColor("#60000000");

    private int mDefaultBorderStrokeWidth = 4;
    private int mDefaultBorderLineLength = 60;
